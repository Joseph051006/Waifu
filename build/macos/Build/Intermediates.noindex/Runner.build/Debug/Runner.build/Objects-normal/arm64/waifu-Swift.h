...
#ifndef WAIFU_SWIFT_H
#define WAIFU_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="waifu",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC5waifu11AppDelegate")
...
SWIFT_CLASS("_TtC5waifu17MainFlutterWindow")
